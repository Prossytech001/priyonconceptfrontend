...
// @route   GET /api/products
// @desc    Get all products or filter by isNew=true
// @access  Public
// router.get('/', async (req, res) => {
//   try {
...
//     const productLimit = parseInt(limit) || 0; // if limit is provided

//     const products = await Product.find(query)
//       .sort({ createdAt: -1 })
//       .limit(productLimit); // Apply limit if > 0
...
//     if (size) {
//       query.sizeVariants = { $elemMatch: { size } };
//     }
...
//     const skip = perPage > 0 ? (parseInt(page) - 1) * perPage : 0;
